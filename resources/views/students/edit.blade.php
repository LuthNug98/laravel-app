	...
	<div class="row">
		...
		@csrf
		   ...
		   <div class="form-group">
		   	 ...
		   	 <input type="text" class="form-control @error('email') is-invalid @enderror" name="email" id="email" placeholder="masukan email" value="{{ $student -> email }}">
		   	 @error('nrp')
		   	 	<div class="invalid-feedback">({{$message}})</div>
		   	 @enderror
		   </div>
		   ...
		   <div class="form-group">
		   	 ...
		   	 <input type="text" class="form-control @error('jurusan') is-invalid @enderror" name="jurusan" placeholder="masukan jurusan" value="{{ $student -> jurusan }}">
		   	 @error('jurusan')
		   	 	<div class="invalid-feedback">({{$message}})</div>
		   	 @enderror
		   </div>
